...
RENAME_MODELS: list[ModelConfig] = [
    ...
    ModelConfig(name="Scheda Valvole", id_cell="F3", match_value="schedavalvole", date_cells=["C54"]),
    ModelConfig(name="Scheda Valvole (Alt)", id_cell="G3", match_value="schedavalvole", date_cells=["C54"]),
    ModelConfig(
    ...
    ModelConfig(name="Valvole di Regolazione", id_cell="T6", match_value="valvolediregolazione", date_cells=["B108"]),
    ModelConfig(
        name="Scheda Controllo Valvole", id_cell="F2", match_value="schedacontrollovalvole", date_cells=["F56"]
    ),
    ModelConfig(
